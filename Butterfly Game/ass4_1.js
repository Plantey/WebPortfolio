...
function squiggly(o){
    ...
    for(var i=0;i<o.num;i++){
            ctx.quadraticCurveTo(o.x+randn(o.random), o.y+randn(o.random), o.x+randn(o.random), o.y+randn(o.random));
...
function shapeEx(o){
    ...
    ctx.lineTo( o.x+5* o.s+rand( o.random),  o.y+7.5* o.s+rand( o.random));
    ctx.lineTo( o.x+7* o.s+rand( o.random),  o.y+5* o.s+rand( o.random));
    ctx.lineTo( o.x+10* o.s+rand( o.random),  o.y+9* o.s+rand( o.random));
    ctx.lineTo( o.x+13* o.s+rand( o.random),  o.y+4* o.s+rand( o.random));
    ctx.lineTo( o.x+9* o.s+rand( o.random),  o.y+17* o.s+rand( o.random));
    ctx.closePath();
    ctx.lineWidth = o.lw;
    ctx.strokeStyle = "hsla(" + o.c + ", 100%, 50%, " + o.a + ")";
    ctx.stroke();
