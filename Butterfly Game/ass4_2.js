...
function butterfly(o){   
    ...
    //head
    ctx.beginPath();
    ctx.arc(o.x+randn(o.rpos), o.y+randn(o.rpos)-15, 15, 0, 2*Math.PI);
    //abdomen
    ctx.moveTo(o.x+randn(o.rpos), o.y+randn(o.rpos));
    ctx.quadraticCurveTo(o.x-25, o.y, o.x+randn(o.rpos), o.y+rand(o.rpos)+80);
    ctx.quadraticCurveTo(o.x+25, o.y, o.x+rand(o.rpos), o.y+randn(o.rpos));
    //top left wing
    ctx.quadraticCurveTo(o.x-100, o.y , o.x+randn(o.rpos)-100-rand(o.rwings), o.y+randn(o.rpos)-100-rand(o.rwings));
    ctx.quadraticCurveTo(o.x, o.y-100 , o.x+randn(o.rpos), o.y+randn(o.rpos));
    //top right wing
    ctx.quadraticCurveTo(o.x, o.y-100, o.x+randn(o.rpos)+100+rand(o.rwings), o.y+randn(o.rpos)-100-rand(o.rwings));
    ctx.quadraticCurveTo(o.x+100, o.y, o.x+randn(o.rpos), o.y+randn(o.rpos));
    //bottom left wing 
    ctx.quadraticCurveTo(o.x-75, o.y , o.x+randn(o.rpos)-100-rand(o.rwings), o.y+randn(o.rpos)+100+rand(o.rwings));
    ctx.quadraticCurveTo(o.x, o.y+75 , o.x+randn(o.rpos), o.y+randn(o.rpos));
    //bottom right wing
    ctx.quadraticCurveTo(o.x+75, o.y , o.x+randn(o.rpos)+100+rand(o.rwings), o.y+randn(o.rpos)+100+rand(o.rwings));
    ctx.quadraticCurveTo(o.x, o.y+75 , o.x+randn(o.rpos), o.y+randn(o.rpos));
    ctx.closePath();
...
//checking colour picker function
console.log(getColour(allColours));