...
var butt = {
    ...
    lw: 1, //line width
    r: 30,
    change:{x:0, y:0, c:0, a: 0, rwings:0, rpos:0, lw:0, r:0} //change values for update properties
}
...
//collision functions
function collision_all(o, array){ //butterfly i parameter one, allCircles is parameter two
...
function collision_spacebar(o1, o2, array){
    ...
    if(hdif < o1.r+o2.r && state.space == true){ //if objects are colliding and space is pressed
        ...
        //console.log("space pressed on circle") //confirms collision
        o1.c = array[index].c; //changes butt.c to the index # objects colour value
    }
}
